...
```
Error: WebDriverError: The application at 'C:\Users\ARV\.apkdemo.apk' does not exist or is not accessible when running "http://127.0.0.1:4723/session" with method "POST"
```
