...
```
Error: waitUntil condition failed with the following reason: WebDriverError: 'GET /element/00000000-0000-0abd-ffff-ffff00000013/attribute/displayed' cannot be proxied to UiAutomator2 server because the instrumentation process is not running (probably crashed). Check the server log and/or the logcat output for more details when running "element/00000000-0000-0abd-ffff-ffff00000013/displayed" with method "GET"
```
